...
def analyze_tire_image(base64_image: str, custom_instructions: str = None, tipo_documento: str = 'pneu'):
    ...
    if tipo_documento == 'despesa':
        prompt = (
            ...
            "2. LOCALIZAÇÃO DO CONSUMIDOR: O CPF ou CNPJ do cliente/consumidor aparece sempre no BLOCO INFERIOR (Rodapé), quase sempre APÓS o Valor Total Pago.\n"
            "3. REGRA DE OURO: Se você encontrar dois números (um no topo e um no rodapé), use APENAS o do TOPO no campo 'cabecalho.cpfcnpj'.\n"
            "4. PROIBIÇÃO: NUNCA coloque o CPF/CNPJ do cliente (rodapé) no campo 'cpfcnpj' do cabeçalho.\n\n"
            "Analise a imagem e retorne o JSON com o campo 'raciocinio' explicando sua escolha.\n\n"
            "ESTRUTURA JSON OBRIGATÓRIA:\n"
            "{\n"
            "  \"raciocinio\": \"Explique brevemente: CNPJ Encontrado no Topo: X. CPF/CNPJ no Rodapé: Y. Selecionado X.\",\n"
            "  \"cabecalho\": {\n"
