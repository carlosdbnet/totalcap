...
def analyze_tire_image(base64_image: str, custom_instructions: str = None, tipo_documento: str = 'pneu'):
    ...
    if tipo_documento == 'despesa':
        prompt = (
            ...
            "1. CABEÇALHO: 'nome' (Razão Social ou Fantasia do posto/restaurante), 'cpfcnpj' (CNPJ do emissor/posto), 'data' (Data de emissão), 'veiculo' ou 'placa', 'km' (Quilometragem se houver).\n"
            ...
            "   - 'quantidade': busque por 'lts', 'litros', 'qtde'\n"
            "   - 'valor_unitario': preço por unidade ou litro\n"
            "   - 'valor_total': subtotal do item\n"
            "   - 'tipo': classifique (Combustível, Pedágio, etc)\n"
            "3. RODAPÉ: O 'valor_total' informando o Total Geral da nota.\n\n"
            "REGRAS GERAIS:\n"
